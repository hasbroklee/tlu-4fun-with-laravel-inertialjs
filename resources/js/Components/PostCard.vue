    ...
    <div class="mt-4 max-w-4xl flex bg-white rounded-lg border border-gray-200 shadow-md">
        ...
        <div>
            ...
            <div class="flex m-2 p-2">
                ...
                <a href="#" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Read more
